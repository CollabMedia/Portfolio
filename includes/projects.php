			...
			<div class="row">
				...
				<div class="col-md-4 col-xs-12">
					<div class="project_content_left">
						...
						<br>
						<p>To log in and use Logic Lead System:</p>
						<ul>
							...
							<div id="Carousel1" class="carousel slide" data-ride="carousel">
								...
								<div class="carousel-inner" role="listbox">
									<div class="item active">
										<img src="images/logicleadsystem.jpg" alt="logicleadsystem">
									</div>
					...
					<div class="project_content_right">
						...
						<!-- Carousel 2 -->
							<div id="carousel2" class="carousel slide" data-ride="carousel">
								...
								<div class="carousel-inner" role="listbox">
									<div class="item active">
										<img src="images/prattle.jpg" alt="prattle">
									</div>
					...
					<div class="project_content_right">
						<div class="project-image">
							...
							<div id="carousel3" class="carousel slide" data-ride="carousel">
								...
								<div class="carousel-inner" role="listbox">
									<div class="item active">
										<img src="images/bookit.png" alt="bookit">
									</div>
